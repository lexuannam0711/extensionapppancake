...
This project is indexed by GitNexus as **extensionapppancake** (4490 symbols, 10589 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
